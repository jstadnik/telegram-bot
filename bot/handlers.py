...
def start(update, context):
    update.message.reply_text("Hi, I am a 20 questions bot! Nice to meet you.\n\n"
...
def error(update, context):
    update.message.reply_text("I seem to have gotten myself into a state..."
...
def setup(updater):
    ...
    conv_handler = ConversationHandler(
        ...
        fallbacks=[CommandHandler('cancel', cancel), CommandHandler('newgame', new_game), CommandHandler('show', show_data), 
